          ...
          >
            ...
            <div className=" bg-[#E7C873] flex flex-col p-6 lg:p-10 rounded-4xl w-full lg:w-1/2 lg:mt-0">
              ...
              <div className="flex mx-auto items-center justify-center mt-8 w-full">
                <button className=" font-bold border-4 border-[#1F4B43] p-2.5 rounded-2xl w-full max-w-xs text-center text-[#1F4B43] mx-auto cursor-pointer hover:bg-[#1F4B43] hover:text-[#E7C873] transition duration-300">
                  SIGN UP
                </button>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <button
                  ...
                  className=" font-bold border-4 border-[#1F4B43] p-2.5 rounded-2xl w-50 text-center text-white mx-auto cursor-pointer"
                >
                  View Profile
                </button>
