...
const Team = () => {
  return (
    <section className="bg-[#F7F7F7] mx-auto p-20 w-full flex flex-col gap-10 ">
      ...
      <div className="grid grid-cols-1 items-center justify-between mx-auto md:grid-cols-2 lg:grid-cols-4 gap-30">
      ...
      <div className="flex flex-col justify-center items-center mt-10">
        <h2 className="font-bold text-2xl mb-2">Popular Real Estate Markets</h2>
